...
-- -------------------------------------------------------------------------------------------------
-- USUÁRIOS (agora VW_USUARIO - simulada como tabela no H2)
-- -------------------------------------------------------------------------------------------------
...
INSERT INTO SGC.VW_USUARIO (titulo, nome, unidade_lot_codigo)
...
-- -------------------------------------------------------------------------------------------------
-- PERFIS DE USUÁRIO (agora VW_USUARIO_PERFIL_UNIDADE - sem ID autoincrementado)
-- -------------------------------------------------------------------------------------------------
