...
class MapaAjusteMapperTest {
    ...
    @DisplayName("Cobertura de Nulos e Combinações")
    class CoberturaExtra {
        ...
        @Test
        @DisplayName("Deve lidar com campos nulos no Subprocesso")
        void deveLidarComCamposNulosNoSubprocesso() {
            Subprocesso sp = new Subprocesso();
        ...
        @Test
        @DisplayName("Deve cobrir todas as combinações de null no toDto")
        void deveCobrirCombinacoesNull() {
            ...
            // Testando as combinações do if complexo na linha 29 para atingir 8/8 branches
            // competencias == null || atividades == null || conhecimentos == null || associacoes == null
            assertThat(mapper.mapCompetencias(null, List.of(), List.of(), Map.of())).isEmpty();
            assertThat(mapper.mapCompetencias(List.of(), null, List.of(), Map.of())).isEmpty();
            assertThat(mapper.mapCompetencias(List.of(), List.of(), null, Map.of())).isEmpty();
            assertThat(mapper.mapCompetencias(List.of(), List.of(), List.of(), null)).isEmpty();
        }
    }
}
