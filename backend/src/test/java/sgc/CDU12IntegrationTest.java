...
class CDU12IntegrationTest {
    ...
    class Sucesso {
        ...
        void semImpactos_QuandoCadastroIdentico() throws Exception {
            ...
            // Act & Assert
            mockMvc.perform(get("/api/subprocessos/{id}/impactos-mapa", subprocessoRevisao.getCodigo()))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.temImpactos", is(false)))
                .andExpect(jsonPath("$.totalAtividadesInseridas", is(0)))
                .andExpect(jsonPath("$.totalAtividadesRemovidas", is(0)))
        ...
        void deveDetectarAtividadesInseridas() throws Exception {
            ...
            mockMvc.perform(get("/api/subprocessos/{id}/impactos-mapa", subprocessoRevisao.getCodigo()))
                ...
                .andExpect(jsonPath("$.totalAtividadesInseridas", is(1)))
        ...
        void deveDetectarAtividadesRemovidas() throws Exception {
            ...
            mockMvc.perform(get("/api/subprocessos/{id}/impactos-mapa", subprocessoRevisao.getCodigo()))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.temImpactos", is(true)))
                .andExpect(jsonPath("$.totalAtividadesRemovidas", is(1)))
        ...
        void deveIdentificarCompetenciasImpactadas() throws Exception {
            ...
            mockMvc.perform(get("/api/subprocessos/{id}/impactos-mapa", subprocessoRevisao.getCodigo()))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.temImpactos", is(true)))
                .andExpect(jsonPath("$.totalAtividadesRemovidas", is(2))) // atividadeVigente1 e atividadeVigente2
                .andExpect(jsonPath("$.totalAtividadesInseridas", is(1)))
    ...
    class BordaEfalhas {
        ...
        void deveRetornar404_QuandoSubprocessoNaoExiste() throws Exception {
            mockMvc.perform(get("/api/subprocessos/{id}/impactos-mapa", 9999L))
