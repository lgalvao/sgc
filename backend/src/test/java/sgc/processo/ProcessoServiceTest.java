...
public class ProcessoServiceTest {
    ...
    void criar_ProcessoValido_CriaComSucesso() {
        CriarProcessoReq requisicao = new CriarProcessoReq("Processo de Teste", "MAPEAMENTO", LocalDate.now().plusDays(30), List.of(1L));
        ...
        ProcessoDto dto = new ProcessoDto(1L, LocalDateTime.now(), null, null, "Processo de Teste", "CRIADO", "MAPEAMENTO");
    ...
    void criar_SemDescricao_LancaConstraintViolationException() {
        CriarProcessoReq requisicao = new CriarProcessoReq("", "MAPEAMENTO", LocalDate.now().plusDays(30), List.of(1L));
    ...
    void criar_SemUnidades_LancaConstraintViolationException() {
        CriarProcessoReq requisicao = new CriarProcessoReq("Processo de Teste", "MAPEAMENTO", LocalDate.now().plusDays(30), Collections.emptyList());
    ...
    void criar_TipoRevisaoComUnidadeNaoEncontrada_LancaErroEntidadeNaoEncontrada() {
        CriarProcessoReq requisicao = new CriarProcessoReq("Processo de Teste", "REVISAO", LocalDate.now().plusDays(30), List.of(999L));
    ...
    void atualizar_ProcessoExisteAtualizaComSucesso() {
        AtualizarProcessoReq requisicao = new AtualizarProcessoReq(1L, "Processo Atualizado", "REVISAO", LocalDate.now().plusDays(45), List.of(1L));
        ...
        ProcessoDto dto = new ProcessoDto(1L, null, null, null, "Processo Atualizado", "CRIADO", "REVISAO");
    ...
    void atualizar_ProcessoNaoEncontrado_LancaErroEntidadeNaoEncontrada() {
        AtualizarProcessoReq requisicao = new AtualizarProcessoReq(999L, null, null, null, null);
    ...
    void atualizar_ProcessoNaoCriado_LancaIllegalStateException() {
        AtualizarProcessoReq requisicao = new AtualizarProcessoReq(1L, null, null, null, null);
    ...
    void obterPorId_ProcessoExiste_RetornaOptionalComDto() {
        ...
        ProcessoDto dto = new ProcessoDto(1L, null, null, null, null, null, null);
    ...
    void obterDetalhes_PerfilAdmin_RetornaDetalhes() {
        ...
        ProcessoDetalheDto detalhes = new ProcessoDetalheDto(1L, null, null, null, null, null, null, Collections.emptyList(), Collections.emptyList());
    ...
    @Test
        ...
        void iniciarProcessoRevisao_Valido_IniciaComSucesso() {
            ...
            when(processoRepo.save(any(Processo.class))).thenReturn(processo);
            when(processoMapper.toDTO(processo)).thenReturn(new ProcessoDto(1L, null, null, null, null, null, null));
