...
@DisplayName("DetectorImpactoCompetenciaService Test")
class DetectorImpactoCompetenciaServiceTest {

    @InjectMocks
    private DetectorImpactoCompetenciaService analisador;
    ...
    void identificarImpactoRemovida() {
        ...
        List<CompetenciaImpactadaDto> res = analisador.competenciasImpactadas(
                List.of(c1),
                List.of(rem),
