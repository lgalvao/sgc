...
class DiagnosticoFluxoServiceTest {
    ...
    @Mock
    SubprocessoValidacaoService subprocessoValidacaoService;
    @Mock
    SubprocessoFluxoContextoService fluxoContextoService;
    @Mock
    LocalizacaoSubprocessoService localizacaoSubprocessoService;
    @Mock
