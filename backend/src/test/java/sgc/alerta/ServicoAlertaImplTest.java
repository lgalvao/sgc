...
class ServicoAlertaImplTest {

    @Mock
    private AlertaRepository repositorioAlerta;

    @Mock
    private AlertaUsuarioRepository repositorioAlertaUsuario;

    @Mock
    private UnidadeRepository repositorioUnidade;

    @Mock
    private SgrhService servicoSgrh;

    @InjectMocks
    private ServicoAlertaImpl servicoAlerta;
