...
class E2eControllerTest {
    ...
    @Mock
    private SituacaoCapacitacaoRepo situacaoCapacitacaoRepo;
    @Mock
    private CacheManager cacheManager;

    private final ProcessoDtoMapper processoDtoMapper = new ProcessoDtoMapper();
    ...
    void setUp() {
        ...
        controller = new E2eController(jdbcTemplate, namedJdbcTemplate, processoService, processoRepo, processoDtoMapper, subprocessoRepo, mapaRepo, diagnosticoRepo, avaliacaoServidorRepo, situacaoCapacitacaoRepo, unidadeService, resourceLoader, cacheManager);
    }
    ...
    void deveCriarProcessoMapeamentoFixture() {
        ...
        assertThat(result.codigo()).isEqualTo(100L);
    }
    ...
    void deveCriarProcessoRevisaoFixture() {
        ...
        ProcessoResumoDto result = controller.criarProcessoRevisao(req);
    ...
    void deveLidarComErroAoResetarBanco() throws Exception {
        ...
        E2eController controllerComErro = new E2eController(mockJdbc, namedJdbcTemplate, processoService, processoRepo, processoDtoMapper, subprocessoRepo, mapaRepo, diagnosticoRepo, avaliacaoServidorRepo, situacaoCapacitacaoRepo, unidadeService, resourceLoader, cacheManager);
    ...
    class CoberturaExtra {
        ...
        void setUp() {
            ...
            var diagnosticoRepoMock = mock(DiagnosticoRepo.class);
            var avaliacaoServidorRepoMock = mock(AvaliacaoServidorRepo.class);
            var situacaoCapacitacaoRepoMock = mock(SituacaoCapacitacaoRepo.class);
            CacheManager cacheManagerMock = mock(CacheManager.class);
            controllerIsolado = new E2eController(jdbcTemplateMock, namedJdbcTemplateMock, processoServiceMock, processoRepoMock, processoDtoMapper, subprocessoRepoMock, mapaRepoMock, diagnosticoRepoMock, avaliacaoServidorRepoMock, situacaoCapacitacaoRepoMock, unidadeServiceMock, resourceLoaderMock, cacheManagerMock);
        }
    ...
    class CoberturaMockTest {
        ...
        void setUp() {
            ...
            diagnosticoRepo = mock(DiagnosticoRepo.class);
            avaliacaoServidorRepo = mock(AvaliacaoServidorRepo.class);
            situacaoCapacitacaoRepo = mock(SituacaoCapacitacaoRepo.class);
        ...
        void resetDatabaseComCacheNulo() throws Exception {
            ...
            E2eController controllerComCacheNulo = new E2eController(
                    jdbcTemplate, namedJdbcTemplate, processoService, processoRepo, processoDtoMapper, subprocessoRepo, mapaRepo, diagnosticoRepo, avaliacaoServidorRepo, situacaoCapacitacaoRepo, unidadeService, resourceLoader, cacheManagerMock);
        ...
        void deveCriarProcessoMapeamentoComMapaComSugestoes() {
            ...
            ProcessoResumoDto result = controller.criarProcessoMapeamentoComMapaComSugestoes(req);
        ...
        void deveCriarProcessoMapeamentoComCadastroDisponibilizado() {
            ...
            ProcessoResumoDto result = controller.criarProcessoMapeamentoComCadastroDisponibilizado(req);
    ...
    void validarAmbienteE2eComProdutoH2MasUrlInvalida() throws Exception {
        ...
        E2eController controllerComMocks = new E2eController(
                jdbcTemplateMock, namedJdbcTemplate, processoService, processoRepo, processoDtoMapper, subprocessoRepo, mapaRepo, diagnosticoRepo, avaliacaoServidorRepo, situacaoCapacitacaoRepo, unidadeService, resourceLoader, cacheManager);
    ...
    void criarProcessoRevisaoComMapaHomologadoDeveUsarDescricaoInformada() {
        ...
        assertThat(resultado.descricao()).isEqualTo("Descrição customizada");
