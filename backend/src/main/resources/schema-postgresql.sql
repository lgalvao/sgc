...
ALTER TABLE sgc.competencia
    DROP CONSTRAINT IF EXISTS fk_competencia_mapa;
ALTER TABLE sgc.competencia
    ADD CONSTRAINT fk_competencia_mapa FOREIGN KEY (mapa_codigo) REFERENCES sgc.mapa;

ALTER TABLE sgc.competencia_atividade
    DROP CONSTRAINT IF EXISTS fk_competencia_atividade_atividade;
ALTER TABLE sgc.competencia_atividade
    ADD CONSTRAINT fk_competencia_atividade_atividade FOREIGN KEY (atividade_codigo) REFERENCES sgc.atividade;

ALTER TABLE sgc.competencia_atividade
    DROP CONSTRAINT IF EXISTS fk_competencia_atividade_competencia;
ALTER TABLE sgc.competencia_atividade
