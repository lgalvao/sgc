...
alter table if exists sgc.avaliacao_servidor
    add constraint fk_avaliacao_servidor foreign key (servidor_titulo) references sgc.usuario;
...
alter table if exists sgc.ocupacao_critica
    add constraint fk_ocupacao_servidor foreign key (servidor_titulo) references sgc.usuario;
