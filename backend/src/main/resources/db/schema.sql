...
(
    ...
    unidade_codigo    bigint       not null,
    usuario_titulo    varchar(12)  not null,
    usuario_matricula varchar(8)   not null,
...
(
    ...
    tipo_notificacao       varchar(80),
    unidade_destino_sigla  varchar(20),
    usuario_destino_titulo varchar(12),
    destinatario           varchar(255)                           not null,
    assunto                varchar(500)                           not null,
    corpo_html             clob                                   not null,
    situacao               varchar(30)  default 'PENDENTE'        not null check
        (
        situacao
            in
        (
    ...
    data_hora_criacao      timestamp(6) default current_timestamp not null,
...
(
    ...
    constraint fk_diagnostico_subprocesso foreign key (subprocesso_codigo) references sgc.subprocesso
);
...
(
    ...
    servidor_nome_snapshot varchar(255),
    competencia_codigo bigint not null,
    autoimportancia    int check (autoimportancia between 0 and 6),
    ...
    constraint fk_avaliacao_competencia foreign key (competencia_codigo) references sgc.competencia,
...
(
    ...
    unidade_sigla_snapshot varchar(20),
    unidade_nome_snapshot varchar(255),
    competencia_codigo   bigint not null,
    situacao_capacitacao varchar(2) check (situacao_capacitacao in ('NA', 'AC', 'EC', 'C', 'I')),
    ...
    constraint fk_ocupacao_competencia foreign key (competencia_codigo) references sgc.competencia,
...
alter table if exists sgc.ocupacao_critica add column if not exists servidor_nome_snapshot varchar(255);
alter table if exists sgc.ocupacao_critica add column if not exists unidade_codigo_snapshot bigint;
alter table if exists sgc.ocupacao_critica add column if not exists unidade_sigla_snapshot varchar(20);
alter table if exists sgc.ocupacao_critica add column if not exists unidade_nome_snapshot varchar(255);
alter table if exists sgc.ocupacao_critica alter column situacao_capacitacao drop not null;
