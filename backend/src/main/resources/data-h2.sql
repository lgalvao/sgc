...
-- Mapa de revisão para testes (CDU-14)
INSERT INTO SGC.MAPA (codigo)
VALUES (201);
...
-- Competências e atividades para mapa de revisão (201) - CDU-14
-- Mapa 201 deve ser idêntico ao mapa 1004 inicialmente para o teste "sem impactos"
INSERT INTO SGC.COMPETENCIA (codigo, mapa_codigo, descricao)
...
-- Assign titulares (chiefs) to units
UPDATE SGC.UNIDADE SET titular_titulo = 777 WHERE codigo = 2; -- STIC
UPDATE SGC.UNIDADE SET titular_titulo = 666666666666 WHERE codigo = 6; -- COSIS
UPDATE SGC.UNIDADE SET titular_titulo = 2 WHERE codigo = 3; -- COAD
UPDATE SGC.UNIDADE SET titular_titulo = 333333333333 WHERE codigo = 8; -- SEDESENV (for CDU09 tests)
UPDATE SGC.UNIDADE SET titular_titulo = 333333333333 WHERE codigo = 9; -- SEDIA (for CDU19 tests)
UPDATE SGC.UNIDADE SET titular_titulo = 333333333333 WHERE codigo = 10; -- SESEL (for CDU10 tests)
UPDATE SGC.UNIDADE SET titular_titulo = 12 WHERE codigo = 11; -- SENIC
UPDATE SGC.UNIDADE SET titular_titulo = 121212121212 WHERE codigo = 12; -- SEJUR
UPDATE SGC.UNIDADE SET titular_titulo = 111111111111 WHERE codigo = 100; -- ADMIN-UNIT
UPDATE SGC.UNIDADE SET titular_titulo = 222222222222 WHERE codigo = 101; -- GESTOR-UNIT
UPDATE SGC.UNIDADE SET titular_titulo = 333333333333 WHERE codigo = 102; -- SUB-UNIT

-- ============================================================================
-- DADOS DE TESTE PARA CDU-02 (Visualizar Painel)
-- ============================================================================
-- Processos para testes de visibilidade
...
-- Unidades participantes dos processos CDU-02
