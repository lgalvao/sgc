...
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (2, 'Secretaria de Informática e Comunicações', 'STIC', 'INTEROPERACIONAL', NULL);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (100, 'ADMIN-UNIT', 'ADMIN-UNIT', 'INTEROPERACIONAL', NULL);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (200, 'Secretaria de Gestao de Pessoas', 'SGP', 'INTERMEDIARIA', NULL);

-- Unidades intermediárias (dependem de raiz)
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (3, 'Coordenadoria de Administracao', 'COAD', 'INTERMEDIARIA', 2);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (6, 'Coordenadoria de Sistemas', 'COSIS', 'INTERMEDIARIA', 2);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (7, 'Coordenadoria de Suporte e Infraestrutura', 'COSINF', 'INTERMEDIARIA', 2);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (14, 'Coordenadoria Jurídica', 'COJUR', 'INTERMEDIARIA', 2);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (101, 'GESTOR-UNIT', 'GESTOR-UNIT', 'INTERMEDIARIA', 100);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (201, 'Coordenadoria de Atenção ao Servidor', 'CAS', 'INTEROPERACIONAL', 200);

-- Unidades intermediárias (dependem de outras intermediárias)
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (4, 'Coordenadoria de Educação Especial', 'COEDE', 'INTERMEDIARIA', 3);

-- Unidades operacionais (dependem de intermediárias)
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (5, 'Seção Magistrados e Requisitados', 'SEMARE', 'OPERACIONAL', 4);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (8, 'Seção de Desenvolvimento de Sistemas', 'SEDESENV', 'OPERACIONAL', 6);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (9, 'Seção de Dados e Inteligência Artificial', 'SEDIA', 'OPERACIONAL', 6);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (10, 'Seção de Sistemas Eleitorais', 'SESEL', 'OPERACIONAL', 6);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (11, 'Seção de Infraestrutura', 'SENIC', 'OPERACIONAL', 7);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (12, 'Seção Jurídica', 'SEJUR', 'OPERACIONAL', 14);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (13, 'Seção de Processos', 'SEPRO', 'OPERACIONAL', 14);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (15, 'Seção de Documentação', 'SEDOC', 'OPERACIONAL', 2);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (102, 'SUB-UNIT', 'SUB-UNIT', 'OPERACIONAL', 101);
INSERT INTO SGC.UNIDADE (codigo, NOME, SIGLA, TIPO, unidade_superior_codigo)
VALUES (202, 'Seção de Atenção ao Servidor', 'SAS', 'OPERACIONAL', 201);
...
INSERT INTO SGC.USUARIO (TITULO_ELEITORAL, NOME, EMAIL, RAMAL, unidade_codigo)
VALUES (333333333333, 'Chefe Teste', 'chefe.teste@tre-pe.jus.br', '3333', 102);
