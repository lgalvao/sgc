...
public final class Mensagens {
    ...
    public static final String DATA_LIMITE_MAIOR_QUE_FIM_ETAPA_ANTERIOR = "A data limite deve ser maior que a data de fim da etapa anterior.";
    ...
    public static final String SUCESSO_DISPONIBILIZACAO_MAPA_BLOCO = "Mapas disponibilizados em bloco";
    ...
    public static final String MAPA_SEM_ATIVIDADES = "O mapa deve ter ao menos uma atividade cadastrada.";
    public static final String ATIVIDADES_SEM_CONHECIMENTOS = "Todas as atividades devem possuir conhecimentos.";
    public static final String COMPETENCIAS_SEM_ATIVIDADE = "Existem competências sem atividades associadas.";
    public static final String ATIVIDADES_SEM_COMPETENCIA = "Existem atividades não associadas a nenhuma competência.";
    ...
    public static final String DIAGNOSTICO_PENDENTE = "Ainda existem avaliações e situações de capacitação pendentes.";
    public static final String DIAGNOSTICO_TODOS_SERVIDORES_IMPOSSIBILITADOS = "Não é possível concluir com todos os servidores impossibilitados.";
    public static final String CONSENSO_JA_APROVADO = "A avaliação de consenso já foi aprovada.";
    ...
    public static final String USUARIO_SEM_EMAIL = "Usuário(a) não tem e-mail cadastrado e não pode receber uma atribuição temporária.";
    ...
    public static final String UNIDADES_INTERMEDIARIA_INVALIDAS = "Unidades intermediárias inválidas: %s";
    ...
    public static final String HIST_CADASTRO_DISPONIBILIZADO = "Cadastro disponibilizado";
    public static final String HIST_CADASTRO_DEVOLVIDO = "Cadastro devolvido para ajustes";
    ...
    public static final String HIST_CADASTRO_REABERTO = "Cadastro reaberto";
    public static final String HIST_REVISAO_DISPONIBILIZADA = "Revisão do cadastro disponibilizada";
    public static final String HIST_REVISAO_DEVOLVIDA = "Revisão do cadastro devolvida para ajustes";
    public static final String HIST_REVISAO_ACEITA = "Revisão do cadastro aceita";
    public static final String HIST_REVISAO_HOMOLOGADA = "Revisão do cadastro homologada";
    public static final String HIST_REVISAO_REABERTA = "Revisão do cadastro reaberta";
    public static final String HIST_MAPA_DISPONIBILIZADO = "Mapa disponibilizado para validação";
    public static final String HIST_MAPA_SUGESTOES_APRESENTADAS = "Sugestões apresentadas para o mapa";
    public static final String HIST_MAPA_VALIDADO = "Mapa validado";
