...
public class MapaServicoImpl implements MapaServico {
    ...
    public void validarMapaCompleto(Long idMapa) {
        ...
        List<Atividade> atividades = repositorioAtividade.findByMapaCodigo(idMapa);
    ...
    private void atualizarVinculosAtividades(Long idCompetencia, List<Long> idsAtividades) {
        ...
        for (Long idAtividade : idsAtividades) {
            if (!repositorioAtividade.existsById(idAtividade)) {
