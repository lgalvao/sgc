...
import sgc.mapper.CompetenciaMapper;
import sgc.model.Mapa;
import sgc.repository.CompetenciaRepository;
...
public class CompetenciaController {
    ...
    public ResponseEntity<CompetenciaDTO> obterCompetencia(@PathVariable Long id) {
        Optional.of(competenciaRepository.findById(id)).orElseGet(Optional::empty);
        Optional<sgc.model.Competencia> c = competenciaRepository.findById(id);
