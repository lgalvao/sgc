...
public class AtividadeController {
     ...
     * persiste, associando-a ao usuário autenticado.
     *
     * @param atividadeDto O DTO contendo os dados da atividade a ser criada.
     * @return Um {@link ResponseEntity} com status 201 Created, o URI da nova atividade no
     *     cabeçalho 'Location' e a atividade criada no corpo da resposta.
     */
    @PostMapping
     ...
     * @return Um {@link ResponseEntity} com status 201 Created, o URI do novo conhecimento e o
     *     {@link ConhecimentoDto} criado no corpo da resposta.
     */
    @PostMapping("/{codAtividade}/conhecimentos")
    @Operation(summary = "Cria um conhecimento para uma atividade")
    public ResponseEntity<ConhecimentoDto> criarConhecimento(
        ...
        URI uri =
                URI.create(
                        "/api/atividades/%d/conhecimentos/%d"
                                .formatted(codAtividade, salvo.getCodigo()));
        return ResponseEntity.created(uri).body(salvo);
    }
    ...
    public ResponseEntity<ConhecimentoDto> atualizarConhecimento(
            @PathVariable Long codAtividade,
        ...
        return ResponseEntity.ok(
                atividadeService.atualizarConhecimento(
                        codAtividade, codConhecimento, conhecimentoDto));
    }
    ...
    public ResponseEntity<Void> excluirConhecimento(
