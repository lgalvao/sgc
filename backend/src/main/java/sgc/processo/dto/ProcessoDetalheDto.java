...
public record ProcessoDetalheDto(
    ...
    public ProcessoDetalheDto {
        unidades = unidades != null ? unidades : new ArrayList<>();
        resumoSubprocessos = resumoSubprocessos != null ? resumoSubprocessos : new ArrayList<>();
    }
    ...
    public record UnidadeParticipanteDTO(
        ...
        public UnidadeParticipanteDTO {
            filhos = filhos != null ? filhos : new ArrayList<>();
        }
    }
}
