...
public class ProcessoService {
    ...
    public ProcessoDTO iniciarProcessoMapeamento(Long id, List<Long> unidadesLista) {
        ...
        publisher.publishEvent(new EventoProcessoIniciado(salvo.getCodigo(), salvo.getTipo(), LocalDateTime.now(), unidadesLista));
    ...
    public ProcessoDTO startRevisionProcess(Long id, List<Long> unidadesLista) {
        ...
        // publicar evento indicando início de revisão (reaproveitamos EventoProcessoIniciado)
        publisher.publishEvent(new EventoProcessoIniciado(salvo.getCodigo(), salvo.getTipo(), LocalDateTime.now(), unidadesLista));
    ...
    public ProcessoDTO finalizeProcess(Long id) {
        ...
        publisher.publishEvent(new EventoProcessoFinalizado(this, salvo.getCodigo()));
