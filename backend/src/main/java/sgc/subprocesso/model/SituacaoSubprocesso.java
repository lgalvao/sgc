    ...
    private boolean transicaoMapeamento(SituacaoSubprocesso nova) {
        return switch (this) {
            ...
            case MAPEAMENTO_MAPA_COM_SUGESTOES ->
                    nova == MAPEAMENTO_MAPA_DISPONIBILIZADO || nova == MAPEAMENTO_MAPA_CRIADO || nova == MAPEAMENTO_CADASTRO_EM_ANDAMENTO;
    ...
    private boolean transicaoRevisao(SituacaoSubprocesso nova) {
        return switch (this) {
            ...
            case REVISAO_MAPA_COM_SUGESTOES ->
                    nova == REVISAO_MAPA_DISPONIBILIZADO || nova == REVISAO_MAPA_AJUSTADO || nova == REVISAO_CADASTRO_EM_ANDAMENTO;
