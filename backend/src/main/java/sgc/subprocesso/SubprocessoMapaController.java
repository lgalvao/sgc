...
public class SubprocessoMapaController {
    ...
    public ImpactoMapaResponse verificarImpactos(@PathVariable Long codigo, @AuthenticationPrincipal Usuario usuario) {
        Subprocesso subprocesso = subprocessoService.buscarSubprocesso(codigo);
    ...
    public ResponseEntity<MensagemResponse> disponibilizarMapa(
        ...
        subprocessoWorkflowService.disponibilizarMapa(codigo, request, usuario);
    ...
    public Mapa salvarMapa(
        ...
        return subprocessoWorkflowService.salvarMapaSubprocesso(codigo, request);
    }
    ...
    public ResponseEntity<Mapa> salvarMapaCompleto(
        ...
        Mapa mapa = subprocessoWorkflowService.salvarMapaSubprocesso(codigo, request);
        return ResponseEntity.ok(mapa);
    }
    ...
    public void apresentarSugestoes(
            ...
            @AuthenticationPrincipal Usuario usuario) {
        subprocessoWorkflowService.apresentarSugestoes(codigo, request.texto(), usuario);
    }

    @GetMapping("/{codigo}/sugestoes")
    @PreAuthorize("isAuthenticated()")
    public Map<String, Object> obterSugestoes(@PathVariable Long codigo) {
        // Facade implementation was empty map. Keep it simple.
    ...
    public ResponseEntity<Void> devolverValidacao(
            ...
            @AuthenticationPrincipal Usuario usuario) {
        subprocessoWorkflowService.devolverValidacao(codigo, request.justificativa(), usuario);
        return ResponseEntity.ok().build();
    }
    ...
    public void aceitarValidacaoEmBloco(@PathVariable Long codigo,
            ...
            @AuthenticationPrincipal Usuario usuario) {
        subprocessoWorkflowService.aceitarValidacaoEmBloco(request.subprocessos(), usuario);
    }
    ...
    public void homologarValidacaoEmBloco(@PathVariable Long codigo,
            @RequestBody @Valid ProcessarEmBlocoRequest request,
            @AuthenticationPrincipal Usuario usuario) {
        subprocessoWorkflowService.homologarValidacaoEmBloco(request.subprocessos(), usuario);
    }
    ...
    public void disponibilizarMapaEmBloco(@PathVariable Long codigo,
        ...
        DisponibilizarMapaRequest dispoReq = DisponibilizarMapaRequest.builder()
                ...
                .build();
        subprocessoWorkflowService.disponibilizarMapaEmBloco(request.subprocessos(), dispoReq, usuario);
    }
    ...
    public ResponseEntity<Mapa> adicionarCompetencia(
        ...
        Mapa mapa = subprocessoWorkflowService.adicionarCompetencia(codigo, request);
        return ResponseEntity.ok(mapa);
    }
    ...
    public ResponseEntity<Mapa> atualizarCompetencia(
            ...
            @Valid @RequestBody CompetenciaRequest request) {
        Mapa mapa = subprocessoWorkflowService.atualizarCompetencia(codigo, codCompetencia, request);
        return ResponseEntity.ok(mapa);
    }
    ...
    public ResponseEntity<Mapa> removerCompetencia(
            @PathVariable Long codigo,
            @PathVariable Long codCompetencia) {
        Mapa mapa = subprocessoWorkflowService.removerCompetencia(codigo, codCompetencia);
        return ResponseEntity.ok(mapa);
    }
}
