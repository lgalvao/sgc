...
public class SubprocessoWorkflowService {
    ...
    public void disponibilizarRevisao(Long codSubprocesso, Usuario usuario) {
        ...
        // Validação extra para revisão: também precisa de pelo menos uma atividade?
        // Sim, mesma regra de negócio do cadastro. Já validado em validarSubprocessoParaDisponibilizacao.
    ...
    private void validarSubprocessoParaDisponibilizacao(
        ...
        if (!subprocessoService.existePeloMenosUmaAtividade(mapa.getCodigo())) {
            throw new ErroValidacao("É necessário cadastrar pelo menos uma atividade.");
        }
    }
    ...
    public void disponibilizarMapa(
        ...
        sp.getMapa().setSugestoesTratadas(true);
    ...
    public void apresentarSugestoes(Long codSubprocesso, String sugestoes, Usuario usuario) {
        ...
        if (sp.getMapa() != null) {
            ...
            sp.getMapa().setSugestoesTratadas(false);
        }
