...
public class SgrhServiceImpl implements SgrhService {
    ...
    public Optional<ResponsavelDto> buscarResponsavelUnidade(Long unidadeCodigo) {
        // TODO: Conectar ao banco SGRH real
        // return
        // responsabilidadeRepository.findByUnidadeCodigoAndAtivaTrue(unidadeCodigo)
        // .flatMap(resp -> {
        // Optional<VwUsuario> titular =
        // usuarioRepository.findByTitulo(resp.getTitularTitulo());
        // Optional<VwUsuario> substituto =
        // usuarioRepository.findByTitulo(resp.getSubstitutoTitulo());
    ...
    public List<PerfilDto> buscarPerfisUsuario(String titulo) {
        ...
        // .map(p -> {
        // Optional<VwUnidade> unidade =
        // unidadeRepository.findByCodigo(p.getId().getUnidadeCodigo());
    ...
    public List<Long> buscarUnidadesPorPerfil(String titulo, String perfil) {
        // TODO: Conectar ao banco SGRH real
        // return
        // perfilUnidadeRepository.findByIdUsuarioTituloAndPerfilAndAtivoTrue(titulo,
        // perfil)
        // .stream()
