...
public class NotificacaoModelosServiceMock extends NotificacaoModelosService {
    ...
    public String criarEmailDeProcessoIniciado(
        ...
        log.debug("[MOCK E2E] Criando e-mail de processo iniciado (mock): Unidade={}, Processo={}, Tipo={}, DataLimite={}",
    ...
    public void criarEmailCadastroDisponibilizado(
        ...
        log.debug("[MOCK E2E] Criando e-mail de cadastro disponibilizado (mock): Unidade={}, Processo={}, Atividades={}",
    ...
    public void criarEmailCadastroDevolvido(
            ...
            String motivo,
            String observacoes) {
        log.debug("[MOCK E2E] Criando e-mail de cadastro devolvido (mock): Unidade={}, Processo={}, Motivo={}, Observacoes={}",
    ...
    public void criarEmailMapaDisponibilizado(
        ...
        log.debug("[MOCK E2E] Criando e-mail de mapa disponibilizado (mock): Unidade={}, Processo={}, DataLimiteValidacao={}",
                nomeUnidade, nomeProcesso, dataLimiteValidacao);
    }

    @Override
    public void criarEmailMapaValidado(String nomeUnidade, String nomeProcesso) {
        log.debug("[MOCK E2E] Criando e-mail de mapa validado (mock): Unidade={}, Processo={}",
    ...
    public void criarEmailProcessoFinalizado(String nomeProcesso, LocalDateTime dataFinalizacao, int quantidadeMapas) {
        log.debug("[MOCK E2E] Criando e-mail de processo finalizado (mock): Processo={}, DataFinalizacao={}, QuantidadeMapas={}",
    ...
    public String criarEmailProcessoFinalizadoPorUnidade(String siglaUnidade, String nomeProcesso) {
        log.debug("[MOCK E2E] Criando e-mail de processo finalizado por unidade (mock): Unidade={}, Processo={}",
    ...
    public String criarEmailProcessoFinalizadoUnidadesSubordinadas(
        ...
        log.debug("[MOCK E2E] Criando e-mail de processo finalizado unidades subordinadas (mock): Unidade={}, Processo={}, Subordinadas={}",
