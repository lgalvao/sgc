...
public class ServicoNotificacaoEmail implements ServicoNotificacao {
    ...
    public void enviarEmail(String para, String assunto, String corpo) {
        processarEnvioDeEmail(new DtoEmail(para, assunto, corpo, false));
    }

    @Transactional
    public void enviarEmailHtml(String para, String assunto, String corpoHtml) {
        processarEnvioDeEmail(new DtoEmail(para, assunto, corpoHtml, true));
    }

    @Transactional
    public void enviarEmailDto(DtoEmail emailDto) {
        processarEnvioDeEmail(emailDto);
    }

    private void processarEnvioDeEmail(DtoEmail emailDto) {
    ...
    public CompletableFuture<Boolean> enviarEmailAssincrono(DtoEmail emailDto) {
    ...
    private void enviarEmailSmtp(DtoEmail emailDto) throws MessagingException, UnsupportedEncodingException {
    ...
    private Notificacao criarEntidadeNotificacao(DtoEmail emailDto) {
