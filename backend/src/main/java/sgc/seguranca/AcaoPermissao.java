...
public enum AcaoPermissao {
    ...
    // ── Diagnóstico ─────────────────────────────────────────────
    VISUALIZAR_DIAGNOSTICO(LEITURA),
    PREENCHER_AUTOAVALIACAO(ESCRITA, SERVIDOR),
    ...
    ACEITAR_CADASTRO_EM_BLOCO(ESCRITA, GESTOR),
    HOMOLOGAR_CADASTRO_EM_BLOCO(ESCRITA, ADMIN),
    HOMOLOGAR_MAPA_EM_BLOCO(ESCRITA, ADMIN),
    DISPONIBILIZAR_MAPA_EM_BLOCO(ESCRITA, ADMIN),
    ACEITAR_MAPA_EM_BLOCO(ESCRITA, GESTOR);
