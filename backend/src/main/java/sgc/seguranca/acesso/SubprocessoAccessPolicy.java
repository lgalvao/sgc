...
public class SubprocessoAccessPolicy extends AbstractAccessPolicy<Subprocesso> {
    ...
    private boolean isAcaoAnaliseOuEscrita(Acao acao) {
        return EnumSet.of(
            EDITAR_CADASTRO, DEVOLVER_CADASTRO, ACEITAR_CADASTRO, HOMOLOGAR_CADASTRO,
            EDITAR_REVISAO_CADASTRO, DEVOLVER_REVISAO_CADASTRO, ACEITAR_REVISAO_CADASTRO, HOMOLOGAR_REVISAO_CADASTRO,
