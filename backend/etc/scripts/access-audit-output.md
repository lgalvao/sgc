...
| Devolver cadastro | ADMIN, GESTOR | MAPEAMENTO_CADASTRO_DISPONIBILIZADO | MESMA_UNIDADE |
| Aceitar cadastro | ADMIN, GESTOR | MAPEAMENTO_CADASTRO_DISPONIBILIZADO | MESMA_UNIDADE |
...
| Devolver revisão de cadastro | ADMIN, GESTOR | REVISAO_CADASTRO_DISPONIBILIZADA | MESMA_UNIDADE |
| Aceitar revisão de cadastro | ADMIN, GESTOR | REVISAO_CADASTRO_DISPONIBILIZADA | MESMA_UNIDADE |
...
| Devolver mapa | ADMIN, GESTOR | MAPEAMENTO_MAPA_COM_SUGESTOES, MAPEAMENTO_MAPA_VALIDADO, REVISAO_MAPA_COM_SUGESTOES, REVISAO_MAPA_VALIDADO | MESMA_UNIDADE |
| Aceitar mapa | ADMIN, GESTOR | MAPEAMENTO_MAPA_COM_SUGESTOES, MAPEAMENTO_MAPA_VALIDADO, REVISAO_MAPA_COM_SUGESTOES, REVISAO_MAPA_VALIDADO | MESMA_UNIDADE |
