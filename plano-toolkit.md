...
- 64 arquivos TypeScript de implementação;
- 8 arquivos JavaScript de implementação ainda pendentes;
...
O núcleo TypeScript está adiantado, mas a migração do toolkit como um todo ainda não terminou: aproximadamente 89% dos
