...
DTOs, Modelos (Getters/Setters), Repositórios (Interfaces) e Configurações. Geralmente cobertos por testes de integração ou seguros por natureza (código gerado/boilerplate).
