...
VALUES (99, 99, 4, 'MAPEAMENTO_MAPA_HOMOLOGADO', CURRENT_TIMESTAMP - INTERVAL '1' DAY);
...
VALUES (99, 99, CURRENT_TIMESTAMP - INTERVAL '3' DAY, CURRENT_TIMESTAMP - INTERVAL '1' DAY, NULL);
...
-- Processo de diagnóstico em andamento para ASSESSORIA_12
INSERT INTO sgc.processo (codigo, data_criacao, data_limite, descricao, situacao, tipo)
VALUES (910, CURRENT_TIMESTAMP - INTERVAL '2' DAY, CURRENT_TIMESTAMP + INTERVAL '20' DAY,
        'Diagnóstico Seed ASSESSORIA_12', 'EM_ANDAMENTO', 'DIAGNOSTICO');

INSERT INTO sgc.unidade_processo (processo_codigo, unidade_codigo, situacao, nome, sigla, tipo, matricula_titular,
                                  titulo_titular, data_inicio_titularidade, unidade_superior_codigo)
VALUES (910, 4, 'EM_ANDAMENTO', 'Assessoria 12', 'ASSESSORIA_12', 'OPERACIONAL', '00151515', '151515',
        CURRENT_TIMESTAMP - INTERVAL '2' DAY, 2);

INSERT INTO sgc.subprocesso (codigo, processo_codigo, unidade_codigo, situacao, data_limite_etapa1)
VALUES (910, 910, 4, 'DIAGNOSTICO_EM_ANDAMENTO', CURRENT_TIMESTAMP + INTERVAL '10' DAY);

INSERT INTO sgc.diagnostico (codigo, subprocesso_codigo, data_conclusao, justificativa_conclusao)
VALUES (910, 910, NULL, NULL);

INSERT INTO sgc.movimentacao (codigo, subprocesso_codigo, unidade_origem_codigo, unidade_destino_codigo, usuario_titulo,
                              data_hora, descricao)
VALUES (910, 910, 4, 4, '151515', CURRENT_TIMESTAMP - INTERVAL '2' DAY + INTERVAL '1' HOUR, 'Processo iniciado');

INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910001, 910, '242424', 'Jon Lord', 99001, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910002, 910, '242424', 'Jon Lord', 99002, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910003, 910, '242424', 'Jon Lord', 99003, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910004, 910, '242424', 'Jon Lord', 99004, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
...
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    ...
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910005, 910, '242425', 'Luiz Fernando Cavalcanti de Moura', 99001, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910006, 910, '242425', 'Luiz Fernando Cavalcanti de Moura', 99002, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910007, 910, '242425', 'Luiz Fernando Cavalcanti de Moura', 99003, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910008, 910, '242425', 'Luiz Fernando Cavalcanti de Moura', 99004, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
...
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    ...
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910009, 910, '242426', 'João Guilherme de Albuquerque Maranhão', 99001, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910010, 910, '242426', 'João Guilherme de Albuquerque Maranhão', 99002, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910011, 910, '242426', 'João Guilherme de Albuquerque Maranhão', 99003, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910012, 910, '242426', 'João Guilherme de Albuquerque Maranhão', 99004, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
...
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    ...
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910013, 910, '242427', 'Maria Eduarda Cavalcanti de Alencar', 99001, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910014, 910, '242427', 'Maria Eduarda Cavalcanti de Alencar', 99002, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910015, 910, '242427', 'Maria Eduarda Cavalcanti de Alencar', 99003, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
INSERT INTO sgc.avaliacao_servidor (codigo, diagnostico_codigo, servidor_titulo, servidor_nome_snapshot, competencia_codigo,
                                    autoimportancia, autodominio, chefia_importancia, chefia_dominio,
                                    consenso_importancia, consenso_dominio, importancia, dominio, gap,
                                    observacoes, situacao_servidor)
VALUES (910016, 910, '242427', 'Maria Eduarda Cavalcanti de Alencar', 99004, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        'AUTOAVALIACAO_NAO_INICIADA');
...
VALUES (200, 2, 'CONCLUIDA', 'Secretaria 1', 'SECRETARIA_1', 'INTEROPERACIONAL', '00202020', '202020',
        CURRENT_TIMESTAMP - INTERVAL '12' DAY, 1);

-- Subprocesso 200
INSERT INTO sgc.subprocesso (codigo, processo_codigo, unidade_codigo, situacao, data_limite_etapa1)
VALUES (200, 200, 2, 'MAPEAMENTO_MAPA_HOMOLOGADO', CURRENT_TIMESTAMP - INTERVAL '2' DAY);

-- Mapa para SECRETARIA_1 (Unidade 2)
INSERT INTO sgc.mapa (codigo, subprocesso_codigo, data_hora_disponibilizado, data_hora_homologado, sugestoes)
VALUES (200, 200, CURRENT_TIMESTAMP - INTERVAL '5' DAY, CURRENT_TIMESTAMP - INTERVAL '2' DAY, NULL);
...
VALUES (1, CURRENT_TIMESTAMP - INTERVAL '1' DAY - INTERVAL '11' HOUR, 99, 2, 1, 'Mapa de competências homologado');
INSERT INTO sgc.alerta (codigo, data_hora, processo_codigo, unidade_origem_codigo, unidade_destino_codigo, descricao)
