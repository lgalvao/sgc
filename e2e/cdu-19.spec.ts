...
import { loginComoChefeSedia } from './helpers/auth';
import { irParaVisualizacaoMapa } from './helpers/navegacao/navegacao';
import {
    apresentarSugestoes,
    validarMapa,
} from './helpers/acoes/acoes-validacao';
import {
    cancelarNoModal,
...
import { gerarNomeUnico, clicarPorTestIdOuRole } from './helpers/utils/utils';
...
test.describe('CDU-19: Validar mapa de competências', () => {
    ...
    test.beforeEach(async ({page}) => {
        ...
        const processoId = await criarProcesso(page, 'MAPEAMENTO', nomeProcesso, ['9']); // Unidade 9 = SEDIA
