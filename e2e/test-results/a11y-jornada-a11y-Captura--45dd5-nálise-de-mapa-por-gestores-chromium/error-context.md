...
- Name: a11y/jornada-a11y.spec.ts >> Captura de Telas - Sistema SGC >> 05 - Mapa de Competências >> Captura análise de mapa por gestores
- Location: e2e/a11y/jornada-a11y.spec.ts:940:9
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 4.35 (foreground color: #8f949a, background color: #2b3035, font size: 10.2pt (13.6px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 4.35 (foreground color: #8f949a, background color: #2b3035, font size: 10.2pt (13.6px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span data-v-267ee191=\"\">Detalhes do processo</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href=\"/processo/400\"] > span[data-v-267ee191=\"\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
