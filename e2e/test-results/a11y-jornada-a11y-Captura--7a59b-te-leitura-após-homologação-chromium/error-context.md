...
- Name: a11y/jornada-a11y.spec.ts >> Captura de Telas - Sistema SGC >> 12 - Modais de Gestão do Mapa >> Captura mapa somente leitura após homologação
- Location: e2e/a11y/jornada-a11y.spec.ts:1530:9
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 4.43 (foreground color: #7a8ba1, background color: #212529, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 4.43 (foreground color: #7a8ba1, background color: #212529, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"mailto:david.bowie@tre-pe.jus.br\" class=\"link-discreto\">david.bowie@tre-pe.jus.br</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".link-discreto",
