...
- Name: a11y/jornada-a11y.spec.ts >> Captura de Telas - Sistema SGC >> 05 - Mapa de Competências >> Captura mapa disponibilizado e validação do chefe
- Location: e2e/a11y/jornada-a11y.spec.ts:914:9
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 4.39 (foreground color: #8f959a, background color: #2b3035, font size: 10.2pt (13.6px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 4.39 (foreground color: #8f959a, background color: #2b3035, font size: 10.2pt (13.6px), font weight: normal). Expected contrast ratio of 4.5:1",
