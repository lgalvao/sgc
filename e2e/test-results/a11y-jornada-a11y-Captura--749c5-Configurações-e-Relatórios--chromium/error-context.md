...
- Name: a11y/jornada-a11y.spec.ts >> Captura de Telas - Sistema SGC >> Admin - Consultas e Configurações >> Captura telas administrativas (Unidades, Histórico, Configurações e Relatórios)
- Location: e2e/a11y/jornada-a11y.spec.ts:1199:9
...
+         "html": "<button class=\"btn btn-outline-primary\" type=\"button\" data-testid=\"btn-abrir-modal-add-admin\"><i aria-hidden=\"true\" class=\"bi bi-person-plus me-1\"></i> Adicionar</button>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".btn-outline-primary",
