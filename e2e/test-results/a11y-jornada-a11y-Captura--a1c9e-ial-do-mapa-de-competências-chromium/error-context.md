...
- Name: a11y/jornada-a11y.spec.ts >> Captura de Telas - Sistema SGC >> 05 - Mapa de Competências >> Captura edição inicial do mapa de competências
- Location: e2e/a11y/jornada-a11y.spec.ts:830:9
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 4.3 (foreground color: #8e939a, background color: #2b3035, font size: 10.2pt (13.6px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 4.3 (foreground color: #8e939a, background color: #2b3035, font size: 10.2pt (13.6px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span data-v-267ee191=\"\">Detalhes do processo</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href=\"/processo/410\"] > span[data-v-267ee191=\"\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.3 (foreground color: #8e939a, background color: #2b3035, font size: 10.2pt (13.6px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span data-v-267ee191=\"\">SECAO_121</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"SECAO_121\"] > span[data-v-267ee191=\"\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 4.31 (foreground color: #3584fd, background color: #212529, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<body>",
+                 "target": Array [
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.31 (foreground color: #3584fd, background color: #212529, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<button class=\"btn btn-outline-primary\" type=\"button\" data-testid=\"btn-abrir-criar-competencia\"><i aria-hidden=\"true\" class=\"bi bi-plus-lg me-1\"></i> Criar competência</button>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".btn-outline-primary",
