...
test.describe.serial('CDU-29 - Consultar histórico de processos', () => {
    ...
    test('Cenario 2: GESTOR pode acessar histórico', async ({_resetAutomatico, page, _autenticadoComoGestor}) => {
    ...
    test('Cenario 3: CHEFE pode acessar histórico', async ({_resetAutomatico, page, _autenticadoComoChefeSecao121}) => {
    ...
    test('Cenario 4: Tabela apresenta colunas corretas', async ({_resetAutomatico, page, _autenticadoComoAdmin}) => {
