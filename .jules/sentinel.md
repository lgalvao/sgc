...
## 2024-05-22 - [DTO Input Sanitization]
**Vulnerability:** Potential Stored XSS in free-text fields (e.g., `justificativa`, `descricao`) within Request DTOs.
**Learning:** While frameworks often auto-escape, the lack of backend sanitization leaves a gap for other clients or future rendering changes.
**Prevention:** Systematically apply `@SanitizarHtml` to all String fields in DTOs that accept free text.
