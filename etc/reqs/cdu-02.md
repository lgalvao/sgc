...
2. Na seção `Processos`, o sistema mostra uma tabela de processos ativos. Devem ser  mostrados apenas os processos que incluam entre as unidades participantes a unidade do usuário e/ou suas unidades subordinadas.
