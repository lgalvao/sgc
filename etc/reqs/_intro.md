...
- **ADMIN**: Administrador do sistema. Esse papel, que será geralmente exercido por servidores da SEDOC, é responsável
  por criar, configurar e monitorar processos (dos três tipos). Usuários que logarem com este perfil estarão associados
  à unidade raiz ADMIN. Este perfil é responsável exclusivo por criar e ajustar os mapas de competências.
