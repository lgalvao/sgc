...
- Implementar regra específica para servidores C13, entendido aqui como a classificação funcional específica prevista na Instrução Normativa nº 68 mencionada na especificação preliminar, cuja referência completa (ano, órgão emissor e link oficial) ainda precisa ser levantada no refinamento funcional, incluindo definição de cinco competências e soma obrigatória de pesos igual a 10.
...
- A regra de C13, entendida aqui como a classificação funcional específica prevista na Instrução Normativa nº 68 citada na especificação preliminar, cuja referência completa (ano, órgão emissor e link oficial) ainda precisa ser levantada, vale para toda autoavaliação do servidor C13 ou apenas para um subconjunto específico de unidades/cargos?
- Quem define as cinco competências e os pesos dos C13 dentro do sistema: ADMIN, chefe da unidade, Secretário ou algum cadastro externo? O refinamento funcional deve anexar a referência normativa completa que fundamenta essa regra para evitar interpretação divergente.
