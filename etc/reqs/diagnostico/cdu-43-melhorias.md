...
1. Ao acessar a tela `Monitoramento do Diagnóstico` ela mostra 3 cards `Servidores`, `Pendentes` e `Situação de capacitação`, a duvida seria se faz sentido ter esses cards.
