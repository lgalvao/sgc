...
- Existência de pelo menos uma unidade subordinada cujo subprocesso:
  - esteja na situação `Concluído`; e
  - tenha localização atual na unidade do usuário.

## Fluxo principal

1. No `Painel`, o usuário acessa um processo de diagnóstico em andamento.

2. O sistema mostra a tela `Detalhes do processo`, exibindo apenas os subprocessos das unidades que compõem a
   hierarquia do usuário, isto é, sua própria unidade e as subordinadas recursivamente.

3. Caso existam unidades subordinadas com subprocessos elegíveis para aceite em bloco do diagnóstico, o sistema exibe,
