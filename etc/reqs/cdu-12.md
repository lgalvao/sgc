...
7. Se alguma divergência tiver sido detectada, sistema exibe a tela modal `Impacto no Mapa de Competências`, com as
   ...
   7.1. `Atividades inseridas`: Se novas atividades tiverem sido adicionadas, esta seção é exibida, enumerando, ao lado
   de um ícone de adição, os elementos da lista montados no passo anterior. Abaixo de cada atividade, deverão ser
   listados também os conhecimentos associados a elas.
