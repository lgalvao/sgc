...
- Superficies exportadas amplas: **28**
...
2. `frontend/src/views/AtribuicaoTemporariaView.vue` [view]
   - score: 66
...
4. `frontend/src/views/processoDetalheAcoes.ts` [view]
   - score: 51
   - sinais: serviceDireto, bolsaDependenciasLarga, superficieAmpla, misturaCamadas, fanoutAlto
...
5. `frontend/src/composables/useFluxoSubprocesso.ts` [composable]
   ...
   - fan-out: 3 categorias / 6 imports arquiteturais
6. `frontend/src/views/MapaView.vue` [view]
   - score: 46
   - sinais: misturaCamadas, fanoutAlto
   - fan-out: 3 categorias / 16 imports arquiteturais
7. `frontend/src/composables/useProcessoCadastroTela.ts` [composable]
   - score: 43
