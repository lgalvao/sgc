...
6. `frontend/src/views/AdministradoresView.vue` [view]
   - score: 30
   - sinais: serviceDireto
   - fan-out: 2 categorias / 4 imports arquiteturais
7. `frontend/src/views/useAcoesBlocoProcesso.ts` [view]
   - score: 29
   - sinais: serviceDireto, superficieAmpla, misturaCamadas
   - fan-out: 3 categorias / 3 imports arquiteturais
8. `frontend/src/views/FeedbacksAdminView.vue` [view]
   - score: 28
   - sinais: serviceDireto, serverStateCaseiro
   - fan-out: 2 categorias / 2 imports arquiteturais
9. `frontend/src/composables/useEstadoOrganizacaoNavegacao.ts` [composable]
   - score: 27
   - sinais: invalidacaoExplicita, estrategiaCache, invalidacaoArquitetural
   - fan-out: 2 categorias / 2 imports arquiteturais
10. `frontend/src/composables/useEstadoPainelNavegacao.ts` [composable]
   - score: 27
   - sinais: invalidacaoExplicita, estrategiaCache, invalidacaoArquitetural
   - fan-out: 1 categorias / 1 imports arquiteturais
