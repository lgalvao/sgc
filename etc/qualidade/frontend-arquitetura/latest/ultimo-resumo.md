...
3. `frontend/src/components/processo/SubprocessoCards.vue` [component]
   - score: 12
   - sinais: booleanoPosicional
4. `frontend/src/composables/useFluxoSubprocesso.ts` [composable]
   - score: 8
   - sinais: booleanoPosicional
5. `frontend/src/stores/unidade.ts` [store]
   - score: 8
   - sinais: booleanoPosicional
6. `frontend/src/components/comum/EditorTextoRico.vue` [component]
   - score: 4
   - sinais: booleanoPosicional
7. `frontend/src/views/subprocessoAcoesAdministrativas.ts` [view]
   - score: 4
   - sinais: booleanoPosicional
8. `frontend/src/components/processo/TabelaProcessos.vue` [component]
   - score: 4
   - sinais: booleanoPosicional
9. `frontend/src/views/subprocessoCarregamento.ts` [view]
   - score: 4
   - sinais: booleanoPosicional
10. `frontend/src/composables/useMapaOrquestracao.ts` [composable]
   - score: 4
   - sinais: booleanoPosicional
