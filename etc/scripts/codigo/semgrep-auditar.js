...
const CAMINHO_REGRA_PADRAO = resolverNaRaiz("etc/qualidade/semgrep/sgc-qualidade.yml");
const CAMINHO_RESULTADO_JSON = resolverNaRaiz("etc/qualidade/semgrep/latest/resultado.json");
const CAMINHO_RESULTADO_MD = resolverNaRaiz("etc/qualidade/semgrep/latest/resumo.md");
...
async function main() {
    ...
    if (args.includes("--help") || args.includes("-h")) {
        exibirAjudaComando({
            ...
            exemplos: [
                "node etc/scripts/sgc.js codigo semgrep auditar",
                "node etc/scripts/sgc.js codigo semgrep auditar --dir backend/src/main/java/sgc/subprocesso",
                "node etc/scripts/sgc.js codigo semgrep auditar --auto --json"
            ]
        });
        return;
    }
