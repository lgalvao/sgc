...
async function main() {
    ...
    if (args.includes("--help") || args.includes("-h")) {
        exibirAjudaComando({
            ...
            exemplos: [
                "node etc/scripts/sgc.js integracao contratos exportar-openapi",
                "node etc/scripts/sgc.js integracao contratos exportar-openapi --url http://127.0.0.1:10000/api-docs",
                "node etc/scripts/sgc.js integracao contratos exportar-openapi --saida /tmp/sgc-openapi.json --json"
            ]
        });
        return;
    }
