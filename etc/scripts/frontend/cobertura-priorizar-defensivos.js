...
const COVERAGE_PATH = path.join(import.meta.dirname, "../../../frontend/coverage/coverage-final.json");
const SMELLS_PATH = path.join(import.meta.dirname, "../../../etc/qualidade/codigo-cheiros/latest/ultimo-snapshot.json");
