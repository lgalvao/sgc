...
async function main() {
    ...
    if (helpMode) {
        exibirAjudaComando({
            ...
            exemplos: [
                "node etc/scripts/sgc.js frontend arquitetura validar",
                "node etc/scripts/sgc.js frontend arquitetura validar --json",
                "node etc/scripts/sgc.js frontend arquitetura validar --base C:/sgc",
            ],
        });
        process.exit(0);
    }
