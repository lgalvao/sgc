    ...
    if (helpMode) {
        exibirAjudaComando({
            ...
            exemplos: [
                ...
                "node etc/scripts/sgc.js frontend cruft validar --json",
                "node etc/scripts/sgc.js frontend cruft validar --base /tmp/sgc --budget /tmp/budget.json --waivers /tmp/waivers.json"
            ]
        });
        process.exit(0);
    }
