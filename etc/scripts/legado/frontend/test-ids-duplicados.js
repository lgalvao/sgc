...
async function executarAliasLegado(argumentos = []) {
    process.stderr.write(
        `${pc.yellow("Aviso:")} script legado 'frontend/test-ids-duplicados.js'. Use ` +
        "'frontend/test-ids-listar-duplicados.js'.\n"
    );
    await executarNode("etc/scripts/frontend/test-ids-listar-duplicados.js", argumentos);
}
