...
async function executarAliasLegado(argumentos = []) {
    process.stderr.write(
        `${pc.yellow("Aviso:")} comando legado 'frontend views auditar-validacoes'. Use ` +
        `'frontend views validacoes-auditar'.\n`
    );
    await executarNode("etc/scripts/frontend/views-validacoes-auditar.js", argumentos);
}
