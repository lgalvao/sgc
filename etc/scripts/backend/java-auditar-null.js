...
const SOURCE_DIR = path.join(import.meta.dirname, '../../../backend/src/main/java/sgc');
const AUDIT_FILE = path.join(import.meta.dirname, '../../../null-checks-audit.txt');
const ANALYSIS_FILE = path.join(import.meta.dirname, '../../../null-checks-analysis.md');
