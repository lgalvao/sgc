...
const CAMINHO_RELATORIO_MD = resolverNaRaiz("etc/qualidade/backend/latest/coesao-auditoria.md");
const CAMINHO_RELATORIO_JSON = resolverNaRaiz("etc/qualidade/backend/latest/coesao-auditoria.json");
...
function exibirAjuda() {
    exibirAjudaComando({
        ...
        scriptDireto: "etc/scripts/backend/coesao-auditar.js",
        ...
        exemplos: [
            ...
            "node etc/scripts/sgc.js backend coesao auditar --json",
            "node etc/scripts/sgc.js backend coesao auditar --sem-gravar"
        ]
    });
}
