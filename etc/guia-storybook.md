...
Este guia documenta como visualizar, testar e utilizar as histórias criadas para os componentes do Sistema de Gestão de Competências (SGC). O Storybook serve como nossa biblioteca viva de componentes e ferramenta de desenvolvimento isolado.

## O que é o Storybook?

O Storybook permite navegar por uma coleção de componentes, visualizar seus diferentes estados e interagir com eles sem a necessidade de navegar por fluxos complexos da aplicação.
