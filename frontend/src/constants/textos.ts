...
export const TEXTOS = {
  ...
  administracao: {
    ...
    NOTIFICACOES_TABELA_TITULO: "Notificações",
    NOTIFICACOES_SEM_REGISTROS: "Nenhuma notificação encontrada",
    NOTIFICACOES_ATUALIZAR: "Atualizar",
    NOTIFICACOES_REENVIAR: "Reenviar",
    NOTIFICACOES_DETALHES: "Detalhes",
    NOTIFICACOES_MODAL_DETALHES_TITULO: "Detalhes da notificação",
