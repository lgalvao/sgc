...
export const TEXTOS = {
  ...
  administracao: {
    ...
    NOTIFICACOES_PENDENTES_TITULO: "Pendentes",
    NOTIFICACOES_CONCLUIDAS_TITULO: "Concluídas",
    NOTIFICACOES_SEM_PENDENCIAS: "Nenhuma pendência",
    NOTIFICACOES_SEM_CONCLUIDAS: "Nenhuma concluída",
    NOTIFICACOES_ATUALIZAR: "Atualizar",
    NOTIFICACOES_REENVIAR: "Reenviar",
    NOTIFICACOES_EMPTY_TITLE: "Nenhuma pendência em processos ativos",
    NOTIFICACOES_EMPTY_DESCRIPTION: "Não há registros para acompanhar neste momento.",
    NOTIFICACOES_BUSCA_LABEL: "Busca",
    NOTIFICACOES_BUSCA_PLACEHOLDER: "Filtrar por processo, unidade, assunto ou destinatário",
    NOTIFICACOES_FILTRO_SITUACAO_LABEL: "Situação",
    NOTIFICACOES_FILTRO_SITUACAO_TODAS: "Todas",
    NOTIFICACOES_PREVIEW_DESTINATARIO: "Para",
    NOTIFICACOES_PREVIEW_CRIACAO: "Criado em",
    NOTIFICACOES_PREVIEW_AVISO: "Preview isolado para evitar que o layout do e-mail afete a tela.",
