<template>
  ...
  >
    <div data-testid="mdl-aceite-mapa-body">
      <p v-if="perfil === 'ADMIN'">
        {{ corpoModal }}
      </p>
      <div
      ...
      >
        ...
        <BFormTextarea
          ...
          data-testid="inp-mdl-aceite-mapa-obs"
        />
        <div class="form-text">
    ...
    <template #footer>
      <BButton
        variant="secondary"
        data-testid="btn-mdl-aceite-mapa-cancelar"
      ...
      <BButton
        variant="success"
        data-testid="btn-mdl-aceite-mapa-confirmar"
