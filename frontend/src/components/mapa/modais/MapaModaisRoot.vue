...
<template>
  <template v-if="!modoSomenteLeitura">
    <CompetenciaEdicaoModal :atividades="atividades" :competencia-para-editar="competenciaSendoEditada"
    ...
    <MapaDisponibilizacaoModal :field-errors="fieldErrors" :loading="loadingDisponibilizacao"
    ...
    <CompetenciaExclusaoModal :descricao="competenciaParaExcluir?.descricao || ''" :loading="loadingExclusao"
  ...
  <MapaAceitacaoModal :homologacao="homologacao" :loading="carregandoFluxoMapa" :mostrar-modal="mostrarModalAceitar"
                      @fechar-modal="$emit('fechar-aceite')"
                      @confirmar-aceitacao="$emit('confirmar-aceitacao', $event)"/>
  <MapaValidacaoModal :loading="carregandoFluxoMapa" :model-value="mostrarModalValidar"
                      @confirmar="$emit('confirmar-validacao')"
                      @update:model-value="$emit('update:mostrarModalValidar', $event)"/>
  <MapaDevolucaoModal :erro="mensagemErroDevolucao" :loading="carregandoFluxoMapa"
  ...
  <MapaSugestoesEnvioModal :erro="mensagemErroSugestoes" :loading="loadingSugestoesEnvio" :model-value="mostrarModalSugestoes"
                           :sugestoes="sugestoes"
  ...
  <MapaSugestoesVisualizacaoModal :model-value="mostrarModalVerSugestoes" :pode-editar="podeApresentarSugestoes"
  ...
  <ImpactoMapaModal v-if="codigoSubprocesso" :impacto="impactos" :loading="loadingImpacto"
                    :mostrar="mostrarModalImpacto" @fechar="$emit('fechar-impacto')"/>
  <HistoricoAnaliseModal :historico="historicoAnalise" :mostrar="mostrarModalHistorico"
