...
const icone = computed(() => {
    switch (props.estado) {
        case 'carregando': return 'bi-hourglass-split'
        case 'sucesso': return 'bi-check-lg'
        case 'erro': return 'bi-exclamation-triangle'
...
const classeVariante = computed(() => {
    switch (props.estado) {
        case 'sucesso': return 'btn-success'
        case 'erro': return 'btn-danger'
