<template>
  <LayoutPadrao>
    ...
    <DiagnosticoFluxoModais
        ...
        :titulo-concluir="TEXTOS.diagnostico.MODAL_CONCLUIR_TITULO"
        :mensagem-concluir="TEXTOS.diagnostico.MODAL_CONCLUIR_MENSAGEM"
        :botao-concluir="TEXTOS.diagnostico.BTN_CONCLUIR_AUTOAVALIACAO"
