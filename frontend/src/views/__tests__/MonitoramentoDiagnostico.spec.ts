        ...
        const mockServidoresVariados = [
            {
                ...
                situacaoLabel: 'Consenso Criado',
                totalCompetencias: 10,
                competenciasAvaliadas: 5,
                tituloEleitoral: '1',
                nome: 'Servidor 1'
            },
            {
                situacao: 'CONSENSO_APROVADO',
                situacaoLabel: 'Consenso Aprovado',
                totalCompetencias: 10,
                competenciasAvaliadas: 10,
                tituloEleitoral: '2',
                nome: 'Servidor 2'
            ...
            {
                situacao: 'AVALIACAO_IMPOSSIBILITADA',
                situacaoLabel: 'Impossibilitada',
                totalCompetencias: 0,
                competenciasAvaliadas: 0,
                tituloEleitoral: '3',
                nome: 'Servidor 3'
            },
            {
