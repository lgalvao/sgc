...
async function gerarRelatorio() {
  ...
  carregando.value = true;
  try {
    await relatoriosStore.buscarRelatorioGapsDiagnostico(codProcessoSelecionado.value, unidadesSelecionadas.value);
  } catch (error) {
...
async function exportarPdf() {
  ...
  carregando.value = true;
  try {
    await relatoriosStore.exportarRelatorioGapsDiagnosticoPdf(codProcessoSelecionado.value, unidadesSelecionadas.value);
  } catch (error) {
