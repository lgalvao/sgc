...
7. O sistema atua, para cada unidade selecionada, da seguinte forma:
   ...
   Para processos de **mapeamento**:
    ...
    O cadastro de atividades e conhecimentos da sua unidade no processo [DESCRIÇÃO_PROCESSO]
   ...
   Para processos de **revisão**:
    ...
    A revisão do cadastro de atividades e conhecimentos da sua unidade no processo [DESCRIÇÃO_PROCESSO] 
   ...
   Para processos de **mapeamento**:
    ...
    no processo [DESCRIÇÃO_PROCESSO] foram submetidos para análise por essa unidade.
   ...
   Para processos de **revisão**:
    ...
    no processo [DESCRIÇÃO_PROCESSO] foram submetidas para análise por essa unidade.
