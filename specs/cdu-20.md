...
5. Caso a situação do subprocesso seja 'Mapa com sugestões', a tela Mapa de competências incluirá ainda, antes do botão
...
10. Se optar por **homologar** (perfil ADMIN):
    ...
    10.6. O sistema redireciona para o painel e mostra a mensagem "Mapa homologado".
