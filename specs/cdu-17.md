...
3. O usuário clica em uma unidade operacional ou interoperacional com subprocesso na situação 'Mapa criado' ou 'Mapa
   ajustado'.
...
7. O sistema verifica:
   ...
   Caso positivo, o sistema habilita o botão `Disponibilizar`. Se alguma das validações falhar, o botão permanecerá
   desabilitado.
...
12. O sistema registra a informação do campo `Observações` no mapa do subprocesso e a informação do campo `Data limite`
