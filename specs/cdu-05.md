...
11. O sistema cria internamente um subprocesso para cada unidade operacional ou unidade interoperacional confirmada no
    diálogo complementar, com os seguintes campos e valores iniciais:
...
12. O sistema cria internamente uma cópia do mapa de competências vigente, juntamente com as suas respectivas atividades
    e conhecimentos, para cada unidade operacional ou unidade interoperacional confirmada no diálogo complementar,
    vinculando cada cópia ao subprocesso da unidade correspondente.
