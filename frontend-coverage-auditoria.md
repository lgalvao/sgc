...
| 13 | `frontend/src/components/processo/ProcessoDiagnosticoAlert.vue` | 16.5 | 3 | 82.35% | P3 |
| 14 | `frontend/src/composables/useMapaSugestoes.ts` | 16.0 | 10 | 80% | P3 |
| 15 | `frontend/src/axios-setup.ts` | 15.5 | 8 | 92.31% | P3 |
| 16 | `frontend/src/components/cadastro/CadastroAcoesHeader.vue` | 15.0 | 6 | 82.35% | P3 |
| 17 | `frontend/src/composables/useOcupacoesCriticasDiagnostico.ts` | 15.0 | 6 | 86.96% | P3 |
| 18 | `frontend/src/composables/useAutoavaliacaoDiagnostico.ts` | 14.5 | 7 | 84.44% | P3 |
| 19 | `frontend/src/views/subprocessoCarregamento.ts` | 14.5 | 7 | 86.27% | P3 |
