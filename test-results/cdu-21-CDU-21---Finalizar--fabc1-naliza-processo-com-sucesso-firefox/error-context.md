...
Locator: getByTestId('tbl-notificacoes').locator('tbody tr').filter({ hasText: 'Finalização do processo Mapeamento CDU-21 1779407660473' }).filter({ hasText: 'secao_221@tre-pe.jus.br' }).filter({ hasText: 'Finalização de processo' }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('tbl-notificacoes').locator('tbody tr').filter({ hasText: 'Finalização do processo Mapeamento CDU-21 1779407660473' }).filter({ hasText: 'secao_221@tre-pe.jus.br' }).filter({ hasText: 'Finalização de processo' }).first()
  ...
  - table:
    - rowgroup:
      - row "Destinatário Click to sort ascending Tipo Click to sort ascending Assunto Click to sort ascending Situação Click to sort ascending Quando Click to sort ascending":
        ...
        - columnheader
    - rowgroup:
      - row "SECAO_321 Mapa disponibilizado Mapa de competências disponibilizado - SECAO_321 Falha Definitiva 21/05/2026 20:09 Detalhes Ver conteúdo do e-mail Tentar reenviar e-mail":
        - cell "SECAO_321"
        - cell "Mapa disponibilizado"
        - cell "Mapa de competências disponibilizado - SECAO_321"
        - cell "Falha Definitiva"
        - cell "21/05/2026 20:09"
        - cell "Detalhes Ver conteúdo do e-mail Tentar reenviar e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
          - button "Tentar reenviar e-mail"
      - row "SECRETARIA_2 Finalização do processo Finalização do processo Mapeamento CDU-21 1779407660473 em unidades subordinadas Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        - cell "SECRETARIA_2"
        - cell "Finalização do processo"
        - cell "Finalização do processo Mapeamento CDU-21 1779407660473 em unidades subordinadas"
        - cell "Pendente"
        - cell "21/05/2026 20:54"
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "ADMIN Finalização do processo Finalização do processo Mapeamento CDU-21 1779407660473 em unidades subordinadas Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        - cell "ADMIN"
        - cell "Finalização do processo"
        - cell "Finalização do processo Mapeamento CDU-21 1779407660473 em unidades subordinadas"
        - cell "Pendente"
      ...
      - row "ADMIN Finalização do processo Finalização do processo Mapeamento CDU-21 1779407660473 em unidades subordinadas Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "COORD_22 Finalização do processo Finalização do processo Mapeamento CDU-21 1779407660473 em unidades subordinadas Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        - cell "COORD_22"
        - cell "Finalização do processo"
        - cell "Finalização do processo Mapeamento CDU-21 1779407660473 em unidades subordinadas"
        - cell "Pendente"
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "SECRETARIA_2 Finalização do processo Finalização do processo Mapeamento CDU-21 1779407660473 Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        - cell "SECRETARIA_2"
        - cell "Finalização do processo"
        - cell "Finalização do processo Mapeamento CDU-21 1779407660473"
        - cell "Pendente"
        - cell "21/05/2026 20:54"
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "SECAO_221 Finalização do processo Finalização do processo Mapeamento CDU-21 1779407660473 Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        - cell "SECAO_221"
        - cell "Finalização do processo"
        - cell "Finalização do processo Mapeamento CDU-21 1779407660473"
        - cell "Pendente"
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "SECRETARIA_2 Início do processo Início de processo de mapeamento de competências em unidades subordinadas Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        - cell "SECRETARIA_2"
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "COORD_22 Início do processo Início de processo de mapeamento de competências em unidades subordinadas Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        - cell "COORD_22"
        - cell "Início do processo"
        - cell "Início de processo de mapeamento de competências em unidades subordinadas"
        - cell "Pendente"
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "ADMIN Início do processo Início de processo de mapeamento de competências em unidades subordinadas Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        - cell "ADMIN"
        - cell "Início do processo"
        - cell "Início de processo de mapeamento de competências em unidades subordinadas"
        - cell "Pendente"
      ...
      - row "ADMIN Início do processo Início de processo de mapeamento de competências em unidades subordinadas Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "SECAO_221 Início do processo Início de processo de mapeamento de competências Pendente 21/05/2026 20:54 Detalhes Ver conteúdo do e-mail":
        - cell "SECAO_221"
        - cell "Início do processo"
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "SECAO_311 Cadastro homologado Cadastro de atividades homologado Enviado 20/05/2026 05:54 Detalhes Ver conteúdo do e-mail":
        - cell "SECAO_311"
        - cell "Cadastro homologado"
        - cell "Cadastro de atividades homologado"
        - cell "Enviado"
        - cell "20/05/2026 05:54"
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
