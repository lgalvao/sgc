...
Locator: getByTestId('tbl-notificacoes').locator('tbody tr').filter({ hasText: 'Finalização do processo Mapeamento CDU-21 1779407617767' }).filter({ hasText: 'secao_221@tre-pe.jus.br' }).filter({ hasText: 'Finalização de processo' }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('tbl-notificacoes').locator('tbody tr').filter({ hasText: 'Finalização do processo Mapeamento CDU-21 1779407617767' }).filter({ hasText: 'secao_221@tre-pe.jus.br' }).filter({ hasText: 'Finalização de processo' }).first()
...
- main:
  ...
  - table:
    ...
    - rowgroup:
      ...
      - row "SECRETARIA_2 Finalização do processo Finalização do processo Mapeamento CDU-21 1779407617767 em unidades subordinadas Pendente 21/05/2026 20:53 Detalhes Ver conteúdo do e-mail":
        - cell "SECRETARIA_2"
        - cell "Finalização do processo"
        - cell "Finalização do processo Mapeamento CDU-21 1779407617767 em unidades subordinadas"
        - cell "Pendente"
        - cell "21/05/2026 20:53"
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "ADMIN Finalização do processo Finalização do processo Mapeamento CDU-21 1779407617767 em unidades subordinadas Pendente 21/05/2026 20:53 Detalhes Ver conteúdo do e-mail":
        - cell "ADMIN"
        - cell "Finalização do processo"
        - cell "Finalização do processo Mapeamento CDU-21 1779407617767 em unidades subordinadas"
        - cell "Pendente"
      ...
      - row "ADMIN Finalização do processo Finalização do processo Mapeamento CDU-21 1779407617767 em unidades subordinadas Pendente 21/05/2026 20:53 Detalhes Ver conteúdo do e-mail":
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "COORD_22 Finalização do processo Finalização do processo Mapeamento CDU-21 1779407617767 em unidades subordinadas Pendente 21/05/2026 20:53 Detalhes Ver conteúdo do e-mail":
        - cell "COORD_22"
        - cell "Finalização do processo"
        - cell "Finalização do processo Mapeamento CDU-21 1779407617767 em unidades subordinadas"
        - cell "Pendente"
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "SECRETARIA_2 Finalização do processo Finalização do processo Mapeamento CDU-21 1779407617767 Pendente 21/05/2026 20:53 Detalhes Ver conteúdo do e-mail":
        - cell "SECRETARIA_2"
        - cell "Finalização do processo"
        - cell "Finalização do processo Mapeamento CDU-21 1779407617767"
        - cell "Pendente"
        - cell "21/05/2026 20:53"
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "SECAO_221 Finalização do processo Finalização do processo Mapeamento CDU-21 1779407617767 Pendente 21/05/2026 20:53 Detalhes Ver conteúdo do e-mail":
        - cell "SECAO_221"
        - cell "Finalização do processo"
        - cell "Finalização do processo Mapeamento CDU-21 1779407617767"
        - cell "Pendente"
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "SECRETARIA_2 Início do processo Início de processo de mapeamento de competências em unidades subordinadas Pendente 21/05/2026 20:53 Detalhes Ver conteúdo do e-mail":
        - cell "SECRETARIA_2"
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "COORD_22 Início do processo Início de processo de mapeamento de competências em unidades subordinadas Pendente 21/05/2026 20:53 Detalhes Ver conteúdo do e-mail":
        - cell "COORD_22"
        - cell "Início do processo"
        - cell "Início de processo de mapeamento de competências em unidades subordinadas"
        - cell "Pendente"
      ...
      - row "ADMIN Início do processo Início de processo de mapeamento de competências em unidades subordinadas Pendente 21/05/2026 20:53 Detalhes Ver conteúdo do e-mail":
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "SECAO_221 Início do processo Início de processo de mapeamento de competências Pendente 21/05/2026 20:53 Detalhes Ver conteúdo do e-mail":
        - cell "SECAO_221"
        - cell "Início do processo"
