...
- main:
  ...
  - table:
    ...
    - rowgroup:
      ...
      - row "SECRETARIA_1 Validação do mapa aceita Validação do mapa de competências da ASSESSORIA_11 submetida para análise - ASSESSORIA_11 Enviado 21/05/2026 20:55 Detalhes Ver conteúdo do e-mail":
        - cell "SECRETARIA_1"
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "ADMIN Validação do mapa aceita Validação do mapa de competências da ASSESSORIA_11 submetida para análise Enviado 21/05/2026 20:55 Detalhes Ver conteúdo do e-mail":
        - cell "ADMIN"
        - cell "Validação do mapa aceita"
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "SECRETARIA_1 Início do processo Início de processo de mapeamento de competências em unidades subordinadas Enviado 21/05/2026 20:55 Detalhes Ver conteúdo do e-mail":
        - cell "SECRETARIA_1"
      ...
      - row "ADMIN Início do processo Início de processo de mapeamento de competências em unidades subordinadas Enviado 21/05/2026 20:55 Detalhes Ver conteúdo do e-mail":
        ...
        - cell "Detalhes Ver conteúdo do e-mail":
          - button "Detalhes"
          - button "Ver conteúdo do e-mail"
      - row "ASSESSORIA_11 Início do processo Início de processo de mapeamento de competências Enviado 21/05/2026 20:55 Detalhes Ver conteúdo do e-mail":
        - cell "ASSESSORIA_11"
        - cell "Início do processo"
