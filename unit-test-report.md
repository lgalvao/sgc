...
**Data:** 02/02/2026 21:56:58
**Total de Classes:** 283
**Com Testes Unitários:** 103
**Sem Testes Unitários:** 180
**Cobertura (Arquivos):** 36.40%
...
### Facades (10/12 testados)
**Faltando Testes (2):**
- `sgc/processo/service/ProcessoFacade.java`
- `sgc/seguranca/login/LoginFacade.java`

### Services (38/42 testados)
**Faltando Testes (4):**
- `sgc/e2e/mock/NotificacaoEmailServiceMock.java`
- `sgc/organizacao/service/UsuarioConsultaService.java`
- `sgc/organizacao/service/UsuarioPerfilService.java`
...
- `sgc/mapa/service/MapaImportacaoListener.java`
