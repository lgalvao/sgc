...
vi.mock('@/mocks/atividades.json', () => ({
  default: [
    { id: 1, descricao: 'Atividade 1', idSubprocesso: 101, conhecimentos: [{ id: 10, descricao: 'Conhecimento A' }] },
    { id: 2, descricao: 'Atividade 2', idSubprocesso: 101, conhecimentos: [{ id: 20, descricao: 'Conhecimento B' }] },
  ],
}));
...
describe('VisAtividades.vue', () => {
  ...
  beforeEach(() => {
    ...
    // Popular atividadesStore.atividades após o reset
