<template>
  <div class="container mt-4">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-4">
        <label class="form-label" for="filtroStatus">Filtrar por situação</label>
        <select id="filtroStatus" v-model="filtroSituacao" class="form-select">
    ...
    <div v-if="mapasFiltrados.length === 0" class="alert alert-warning">Nenhum mapa encontrado para o filtro.</div>
    <div class="row mt-4">
