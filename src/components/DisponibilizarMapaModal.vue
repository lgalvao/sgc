<template>
  <div v-if="mostrar" aria-labelledby="disponibilizarModalLabel" aria-modal="true"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div v-if="notificacao" class="alert alert-info mt-3">
            {{ notificacao }}
          </div>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button :disabled="!dataLimiteValidacao" class="btn btn-success" type="button" @click="disponibilizar">
            Disponibilizar
          </button>
        </div>
      </div>
...
function setNotificacao(mensagem: string) {
