...
if (!novaVersao) {
    console.error("Uso recomendado: node toolkit/sgc.js projeto versao-sincronizar <versao>");
    console.error("Execução direta: node toolkit/projeto/versao-sincronizar.js <versao>");
    process.exit(1);
}
