...
if (HELP) {
    console.log(`
Uso recomendado: node toolkit/sgc.js frontend telas capturar [categoria] [opções]
Execução direta: node toolkit/frontend/telas-capturar.js [categoria] [opções]
...
const child = spawn(npx, cmdArgs, {
    stdio: 'inherit',
    cwd: path.join(import.meta.dirname, '../../../') // Root of project
});
