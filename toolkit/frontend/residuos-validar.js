    ...
    if (exibirAjuda) {
        exibirAjudaComando({
            ...
            exemplos: [
                ...
                "npx tsx toolkit/sgc.js frontend residuos validar --json",
                "npx tsx toolkit/sgc.js frontend residuos validar --base /tmp/sgc --orcamento /tmp/orcamento.json --excecoes /tmp/excecoes.json"
            ]
        });
        return;
    }
