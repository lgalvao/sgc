...
const BACKEND_DIR = path.join(import.meta.dirname, '../../../backend/src/main/java/sgc');
const REPORT_FILE = path.join(import.meta.dirname, '../../../frontend-backend-validation-comparison.md');
