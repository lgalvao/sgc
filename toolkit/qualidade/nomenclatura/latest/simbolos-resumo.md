...
Gerado em: 2026-05-20T19:56:53.906Z Base: /home/runner/work/sgc/sgc
...
- sgc (1 arquivo (s))
- sgc.alerta (20 arquivo (s))
- sgc.alerta.dto (10 arquivo (s))
- sgc.alerta.model (12 arquivo (s))
- sgc.alerta.notificacao (1 arquivo (s))
- sgc.arquitetura (2 arquivo (s))
- sgc.comum (2 arquivo (s))
- sgc.comum.config (6 arquivo (s))
- sgc.comum.dto (1 arquivo (s))
- sgc.comum.erros (17 arquivo (s))
- sgc.comum.json (1 arquivo (s))
- sgc.comum.model (7 arquivo (s))
- sgc.comum.util (10 arquivo (s))
- sgc.configuracoes (8 arquivo (s))
- sgc.configuracoes.model (6 arquivo (s))
- sgc.e2e (8 arquivo (s))
- sgc.feedback (13 arquivo (s))
- sgc.feedback.dto (4 arquivo (s))
- sgc.fixture (8 arquivo (s))
- sgc.integracao (60 arquivo (s))
- sgc.integracao.mocks (13 arquivo (s))
- sgc.mapa (6 arquivo (s))
- sgc.mapa.dto (29 arquivo (s))
- sgc.mapa.model (21 arquivo (s))
- sgc.mapa.service (12 arquivo (s))
- sgc.organizacao (17 arquivo (s))
- sgc.organizacao.dto (21 arquivo (s))
- sgc.organizacao.model (43 arquivo (s))
- sgc.organizacao.service (23 arquivo (s))
- sgc.processo (5 arquivo (s))
- sgc.processo.dto (16 arquivo (s))
- sgc.processo.model (13 arquivo (s))
- sgc.processo.painel (6 arquivo (s))
- sgc.processo.painel.dto (1 arquivo (s))
- sgc.processo.service (5 arquivo (s))
- sgc.relatorio (10 arquivo (s))
- sgc.relatorio.service (2 arquivo (s))
- sgc.security (1 arquivo (s))
- sgc.seguranca (7 arquivo (s))
- sgc.seguranca.config (5 arquivo (s))
- sgc.seguranca.dto (8 arquivo (s))
- sgc.seguranca.login (17 arquivo (s))
- sgc.seguranca.login.dto (2 arquivo (s))
- sgc.seguranca.sanitizacao (5 arquivo (s))
- sgc.subprocesso (3 arquivo (s))
- sgc.subprocesso.dto (43 arquivo (s))
- sgc.subprocesso.eventos (1 arquivo (s))
- sgc.subprocesso.model (19 arquivo (s))
- sgc.subprocesso.service (27 arquivo (s))
- sgc.testutils (2 arquivo (s))
- sgc.util (1 arquivo (s))

## Top 20 arquivos por densidade de membros
