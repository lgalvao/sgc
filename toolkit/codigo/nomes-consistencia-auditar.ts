...
async function principal(argumentos: string[] = process.argv.slice(2)): Promise<void> {
    ...
    if (argumentosValidados.includes("--help") || argumentosValidados.includes("-h")) {
        escreverLinha("Uso: npx tsx toolkit/ferramentas.ts codigo nomes auditar-consistencia [--json] [--gravar] [--base <diretorio>] [--inventario <arquivo.json>] [--saida <arquivo.json>]");
        escreverLinha("");
