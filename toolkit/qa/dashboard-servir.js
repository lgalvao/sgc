...
if (process.argv.includes("--help") || process.argv.includes("-h")) {
  ...
  node toolkit/qa/dashboard-servir.js [--host 127.0.0.1] [--porta 4179]

Exemplos:
  node toolkit/sgc.js qa dashboard servir
  node toolkit/sgc.js qa dashboard servir --porta 4180
`);
    process.exit(0);
}
...
const caminhoDashboard = "/toolkit/qa-dashboard/dashboard.html";
