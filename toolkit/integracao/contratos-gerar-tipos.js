...
async function main() {
    ...
    if (args.includes("--help") || args.includes("-h")) {
        exibirAjudaComando({
            ...
            exemplos: [
                "node toolkit/sgc.js integracao contratos gerar-tipos",
                "node toolkit/sgc.js integracao contratos gerar-tipos --entrada /tmp/openapi.json",
                "node toolkit/sgc.js integracao contratos gerar-tipos --saida frontend/src/generated/sgc-openapi.d.ts --json"
            ]
        });
        return;
    }
