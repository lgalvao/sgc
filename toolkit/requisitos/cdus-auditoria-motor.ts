...
import {analisarArquivo, lerArquivo, listarArquivosCdu, validarLinksMarkdown, type AnaliseCdu} from "./cdus-documentos-lib.js";
...
interface AuditoriaCdus {
    ...
    secoes: {
        estrutura?: RelatorioAuditoriaCdu;
...
function selecionarSecoesAuditoria(argumentos: readonly string[] | undefined): Set<SecaoAuditoria> {
...
async function auditarCdus(base: string, secoesInformadas?: readonly string[]): Promise<AuditoriaCdus> {
...
async function auditarEstrutura(base: string, arquivosInformados?: readonly string[]): Promise<RelatorioAuditoriaCdu> {
