...
A validação do mapa de competências da [SIGLA_UNIDADE_SUBPROCESSO] no processo [DESCRIÇÃO_PROCESSO] foi devolvida para ajustes.
...
8.10.2. Processo: [DESCRIÇÃO DO PROCESSO]
...
A validação do mapa de competências da [SIGLA_UNIDADE_SUBPROCESSO] no processo [DESCRIÇÃO_PROCESSO] foi submetida para análise por essa unidade.
...
9.8.2. Processo: [DESCRIÇÃO DO PROCESSO]
