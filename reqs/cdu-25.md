...
3. O sistema identifica que existem unidades subordinadas com subprocessos elegíveis para aceitação em bloco do mapa de competências (de acordo com as pré-condições do caso de uso).
...
10. O sistema mostra mensagem de confirmação: "Cadastros aceitos em bloco" e redireciona para o Painel.
