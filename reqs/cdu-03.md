...
5. O sistema faz as seguintes validações (com mensagens de falha de validação indicadas entre aspas):
   ...
   5.3. Em caso de processos dos tipos 'Revisão' ou 'Diagnóstico', só poderão ser selecionadas unidades com mapas de competência vigentes. A mensagem de aviso a ser mostrada, caso contrário: "Não é possível incluir em processos de revisão ou diagnóstico, unidades que ainda não passaram por processo de mapeamento."
