...
6. O sistema mostra a tela `Edição de mapa` preenchida com o mapa do subprocesso da unidade (ver detalhes sobre a tela no caso de uso _Manter mapa de competências_, com os botões Impactos no mapa e `Disponibilizar`.
